...
# import data
csv_file = 'Projects/PTCDI/data PTCDI.csv'
...
parameters_1, covariance_1 = curve_fit(func, Energy, Counts_1, absolute_sigma=True, bounds=(
    [0.0000001, 2.28999999, 0.1699999, 0.00000001, 2.4899999, 0.1199999], [1, 2.290000001, 0.17000001, 1, 2.490000001, 0.12000001]))
parameters_2, covariance_2 = curve_fit(func, Energy, Counts_2, absolute_sigma=True, bounds=(
    [0.0000001, 2.2899999999, 0.1699999, 0.00000001, 2.4899999, 0.1199999], [1, 2.290000001, 0.17000001, 1, 2.490000001, 0.12000001]))
...
textfile = open("Projects/PTCDI/Output/280ps-msf_file.txt", "w")
for element in fit_y5:
    textfile.write(str(element) + "\n")
textfile.close()


textfile = open("Projects/PTCDI/Output/100ps-msf_file.txt", "w")
for element in fit_y4:
    textfile.write(str(element) + "\n")
textfile.close()


textfile = open("Projects/PTCDI/Output/30ps-msf_file.txt", "w")
for element in fit_y3:
    textfile.write(str(element) + "\n")
textfile.close()


textfile = open("Projects/PTCDI/Output/10ps-msf_file.txt", "w")
for element in fit_y2:
    textfile.write(str(element) + "\n")
textfile.close()

textfile = open("Projects/PTCDI/Output/1ps-msf_file.txt", "w")
...
plt.legend()
plt.savefig("Projects/PTCDI/Output/free_fit-msf.png")
plt.show()

original_stdout = sys.stdout
with open('Projects/PTCDI/Output/parameters-ratio-msf.txt', 'w') as f:
